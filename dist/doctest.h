...
// =================================================================================================
    ...
    struct ConsoleReporter : public IReporter
    {
        ...
        void printHelp() {
            ...
            s << " -" DOCTEST_OPTIONS_PREFIX_DISPLAY "removed,   --" DOCTEST_OPTIONS_PREFIX_DISPLAY "reporters=<filters>           "
...
void Context::parseArgs(int argc, const char* const* argv, bool withDefaults) {
    ...
    parseCommaSepArgs(argc, argv, DOCTEST_CONFIG_OPTIONS_PREFIX "removed=",                  p->filters[8]);
    // clang-format on
